const Manager_req  = Vue.component("home", {
    template: `
                    ...
                    <span class="subheading">You can add catogery to suggest manager</span>
                                                            ...
                                                            <button type="button" class="btn btn-primary" >            <a @click="home()" class="pt-3">HOME</a>  </button>
                                                              ...
                                                              <div class="row">
                                                                ...
                                                                <h4 class="pt-3">REJECT REQUEST</h4>
                                                                  
                                                                </div>
                                                              </div>
                                                              <div class="row">
                                                                <div v-for="cato in man_req":key="cato.id" class="col-md-6 col-xl-4 col-12 pt-3  justify-content-around d-flex">
                                                                                                                                                          ...
                                                                                                                                                          <div class="row gx-6 gxlg-7 justify-content-center">
                                                                                                                                                              ...
                                                                                                                                                              <!-- Post preview-->
                                                                                                                                                                  ...
                                                                                                                                                                  <a >
                                                                                                                                                                      ...
                                                                                                                                                                      <div class="btn-group">                                            
                                                                                                                                                                      <a @click="cato_req(cato.id,1,1,1,1)" class="btn btn-sm btn-outline-secondary" >ALLOW</a>
