const Admin_reject  = Vue.component("home", {
    template: `
                        ...
                        <div>
                                                              ...
                                                              <div class="row">
                                                                ...
                                                                <div class="col-12 text-center">
                                                                  <h4 class="pt-3">PENDING REQUEST</h4>
                                                                  
                                                                </div>
                                                              </div>
                                                              <div class="row">
                                                                <div v-for="cato in this.not_catos":key="cato.id" class="col-md-6 col-xl-4 col-12 pt-3  justify-content-around d-flex">
